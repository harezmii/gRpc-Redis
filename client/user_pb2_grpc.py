...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.UserWriteRedis = channel.unary_unary(
                '/UserService/UserWriteRedis',
...
class UserServiceServicer(object):
    ...
    def UserWriteRedis(self, request, context):
        """unary rpc
        """
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'UserWriteRedis': grpc.unary_unary_rpc_method_handler(
                    servicer.UserWriteRedis,
...
class UserService(object):
    ...
    def UserWriteRedis(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/UserService/UserWriteRedis',
